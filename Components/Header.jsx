  ...
  return (
    <div className='py-5 px-5 md:px-12 lg:px-28'>
        ...
        <div className='text-center my-8'>
            ...
            Welcome to our blog platform! We invite you to share your thoughts, stories, and insights with our vibrant community. Whether you're a seasoned writer or just starting out, this space is designed for everyone. Join us in fostering creativity, connection, and conversation as we explore diverse topics together!
            </p>
